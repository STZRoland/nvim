...
return {
    ...
    config = function()
        ...
        local on_attach = function(client, bufnr)
            ...
            keymap.set("n", "<S-k>", vim.lsp.buf.hover, opts) -- show documentation for what is under cursor

            opts.desc = "Restart LSP"
            keymap.set("n", "<leader>ll", ":LspRestart<CR>", opts) -- mapping to restart lsp if necessary
        end

        -- required to enable autocompleteion (assign to every lsp server config)
